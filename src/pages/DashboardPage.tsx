...
export function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-amber-100/50 px-5 py-6 font-mono text-black sm:px-8 lg:px-14">
      <header className="mx-auto flex max-w-6xl items-center justify-between gap-4"><PixelBrand /><button className="border-2 border-black bg-white px-4 py-2 text-xs font-black uppercase shadow-[3px_3px_0_#151515] transition enabled:hover:bg-red-600 disabled:opacity-60" type="button" onClick={handleLogout} disabled={isLeaving}>{isLeaving ? 'Saindo...' : 'Sair'}</button></header>
